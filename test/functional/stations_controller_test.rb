...
class StationsControllerTest < ActionController::TestCase
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post :create, station: { description: @station.description, homepage_url: @station.homepage_url, name: @station.name }
    end
  ...
  test "should update station" do
    put :update, id: @station, station: { description: @station.description, homepage_url: @station.homepage_url, name: @station.name }
    assert_redirected_to station_path(assigns(:station))
  end
